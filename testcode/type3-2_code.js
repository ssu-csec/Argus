(() => {
    ...
    var e = {
            7028: (e, t) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.config = t.PixieConfig = void 0;
                class n {
                    constructor() {
            ...
            5191: (e, t, n) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.sendTrackEvent = t.buildPixel = t.propertyMap = void 0;
                const i = n(7514), o = n(1037), s = n(2656);
                let r = 0;
                function a(e, n, i) {
                    return new s.Pixel({
                        properties: (o = Object.assign({ event: e }, n), Object.keys(o).reduce((e, n) => {
                            const i = t.propertyMap[n] || n, s = o[n];
                            return [
                                ...e,
                ...
                t.propertyMap = {
                    ...
                    (0, o.broadcastEvent)(o.TRACK_PIXEL_EVENT, { trackEvent: s }), a(t, n, (e, t) => {
                        (0, o.broadcastEvent)(e ? o.TRACK_PIXEL_EVENT_SUCCESS : o.TRACK_PIXEL_EVENT_FAILURE, { trackEvent: Object.assign(Object.assign({}, s), { loadDuration: t }) });
                    }).send();
                };
            },
            7514: (e, t, n) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.logger = t.ConsoleLogger = void 0;
                const i = n(7028);
                class o {
                    constructor({label: e} = {}) {
                        this.label = e;
            ...
            8915: (e, t, n) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.Pixie = t.buildMetaData = t.isInIframe = void 0;
                const i = n(2831), o = n(7028), s = n(5191), r = n(7514), a = n(1037), u = n(5954), d = n(589);
                function l() {
                    try {
                ...
                function c(e = new Date().getTime()) {
                    const {href: t} = window.location, {referrer: n} = document;
                    return {
                        version: "0.0.41",
                        href: t,
                        referrer: n,
                ...
                t.isInIframe = l, t.buildMetaData = c, t.Pixie = class {
                    constructor(e = []) {
                        this.version = "0.0.41", this.pixelIds = [], this.uetHandler = null, this.actionQueue = [], this.uetActionQueue = [], this.XANDR_VENDOR_ID = 32, this.tcf = {
                            enabled: !1,
                            consent: !1,
                            hasLoaded: !1,
                            hasWaited: !1,
                            ...
                            hasWaited: !1,
                            updated: !1
                        }, this.hasUET = !1, this.queueAction = (e, t, n) => {
                            ...
                            if (!n.length && Array.isArray(i)) {
                                const [[n = null], o] = i.reduce((e, t) => (e["init" !== t.action || e[0].length ? 1 : 0].push(t), e), [
                                    [],
                                    []
                                ]);
                            ...
                            "consent" === e ? this.processBinaryConsent(t, n) : "config" === e ? this.processTCFConsent(t, n) : "init" === e ? void 0 !== (null == n ? void 0 : n.psEnabled) ? this.init(t, !!n.psEnabled) : this.init(t) : "event" === e ? (this.track(t, n), this.hasUET && (null != this.uetHandler ? this.uetTrack(t, n) : this.uetActionQueue.push({
                                action: e,
                                actionValue: t,
                                params: n
                            }))) : r.logger.error(`Could not find action '${ e }'`);
                        }, this.setUetEventHandler = e => {
                            r.logger.debug("setUetEventHandler", e), this.uetHandler = e, this.uetTrack("PageView"), this.processUETActionQueue();
                        }, this.uetTrack = (e, t) => {
                            let n = 0, i = "USD";
                            ...
                            r.logger.debug("uetTrack", e, o), this.uetHandler(e, o);
                    ...
                    async init(e, t) {
                        if (this.pixelIds.filter(({pixelId: t}) => t === e).length)
                            ...
                            this.mid = (0, i.v4)(), this.pixelIds.push(n), (0, a.broadcastEvent)(a.INIT_PIXEL, { pixel: n });
                            const s = await async function (e, t, n) {
                                try {
                                    o.config.updateBaseURLs(!e);
                                    const i = { pi: t };
                                    void 0 !== (null == n ? void 0 : n.psEnabled) && (i.psEnabled = n.psEnabled);
                                    const s = Object.keys(i).map(e => `${ e }=${ i[e] }`).join("&"), r = await fetch(`${ o.config.upBaseURL }?${ s }`, {
                                            mode: "cors",
                                            credentials: "include"
                                        });
                                    if (!r)
                            ...
                            this.hasConsent() && (null == this.uet && void 0 !== (null == s ? void 0 : s.uet) && null !== (null == s ? void 0 : s.uet) && (this.uet = new u.UET(this, o.config.upAttributeName, e, s.uet)), (0, d.initInterestGroups)(e, s)), this.processActionQueue();
                        }
                    }
                };
            },
            497: (e, t) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.Timer = void 0, t.Timer = class {
                    static now() {
            ...
            5954: (e, t, n) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.UET = void 0;
                const i = n(7514);
                t.UET = class {
                    constructor(e, t, n, i) {
                    ...
                    onloadCallback(e) {
                        ...
                        if (null != t) {
                            const n = window[t];
                            n.hasUET = !0, i.logger.debug("LOAD :: up: " + t + " ev: " + e.type + " mid: " + n.getMid() + " pid: ");
                            for (const e of n.pixelIds)
                                i.logger.debug(e.pixelId);
                        }
                    }
                    onErrCallback(e) {
                        const t = this.getAttribute("data-upo");
                        if (null != t) {
                            const n = window[t];
                            n.hasUET = !1, i.logger.debug("ERROR :: up: " + t + " ev: " + e.type + " mid: " + n.getMid() + " pid: " + n.pixelIds.toString());
                            for (const e of n.pixelIds)
                                i.logger.debug(e.pixelId);
                        }
                    }
            ...
            589: function (e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", { value: !0 }), t.initInterestGroups = t.buildGroup = t.fetchAds = t.supportsInterestGroups = void 0;
                const o = i(n(7758)), s = 864e5 * o.default.DEFAULT_LIFETIME_DAYS;
                var r;
                !function (e) {
                ...
                t.supportsInterestGroups = l, t.fetchAds = async function (e) {
                    const t = await fetch(e);
                    return t ? await t.json() : (console.debug("No response; no ads."), []);
                }, t.buildGroup = c, t.initInterestGroups = async function (e, t) {
                    var n;
                    if (!l())
                        return;
                    if (!t || !(null === (n = null == t ? void 0 : t.ps) || void 0 === n ? void 0 : n.guid))
                        return;
                    const i = localStorage.getItem(o.default.LOCAL_STORAGE_KEY);
                    if (null !== i)
                        return void console.debug(`Already joined interest group @ ${ i }`);
                    const r = await c(t.ps.advertiserId, e, t.ps.guid);
            ...
            2831: (e, t, n) => {
                ...
                var i = f(n(3518)), o = f(n(4948)), s = f(n(5073)), r = f(n(7186)), a = f(n(4808)), u = f(n(7775)), d = f(n(7037)), l = f(n(9910)), c = f(n(6792));
                function f(e) {
                    return e && e.__esModule ? e : { default: e };
                }
            },
            2311: (e, t) => {
                ...
                t.default = function (e) {
                    ...
                    return function (e) {
                        ...
                        if (0 === e.length)
                            return [];
                        const t = 8 * e.length, i = new Uint32Array(n(t));
                        for (let n = 0; n < t; n += 8)
            ...
            6792: (e, t, n) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.default = void 0;
                var i, o = (i = n(7037)) && i.__esModule ? i : { default: i };
                t.default = function (e) {
                    if (!(0, o.default)(e))
            ...
            9042: (e, t) => {
                ...
                t.default = function (e) {
                    ...
                    e.push(128);
                    const s = e.length / 4 + 2, r = Math.ceil(s / 16), a = new Array(r);
                    for (let t = 0; t < r; ++t) {
                    ...
                    for (let e = 0; e < r; ++e) {
                        ...
                        let r = o[0], u = o[1], d = o[2], l = o[3], c = o[4];
                        for (let e = 0; e < 80; ++e) {
                            const o = Math.floor(e / 20), a = i(r, 5) + n(o, u, d, l) + c + t[o] + s[e] >>> 0;
                            c = l, l = d, d = i(u, 30) >>> 0, u = r, r = a;
                        }
                        o[0] = o[0] + r >>> 0, o[1] = o[1] + u >>> 0, o[2] = o[2] + d >>> 0, o[3] = o[3] + l >>> 0, o[4] = o[4] + c >>> 0;
                    }
                    return [
                        o[0] >> 24 & 255,
                        o[0] >> 16 & 255,
            ...
            9910: (e, t, n) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.default = void 0, t.unsafeStringify = r;
                var i, o = (i = n(7037)) && i.__esModule ? i : { default: i };
                const s = [];
                for (let e = 0; e < 256; ++e)
            ...
            3518: (e, t, n) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.default = void 0;
                var i, o = (i = n(2858)) && i.__esModule ? i : { default: i }, s = n(9910);
                let r, a, u = 0, d = 0;
                t.default = function (e, t, n) {
                    let i = t && n || 0;
                    const l = t || new Array(16);
                    let c = (e = e || {}).node || r, f = void 0 !== e.clockseq ? e.clockseq : a;
                    if (null == c || null == f) {
                    ...
                    let p = void 0 !== e.msecs ? e.msecs : Date.now(), h = void 0 !== e.nsecs ? e.nsecs : d + 1;
                    const g = p - u + (h - d) / 1e4;
                    if (g < 0 && void 0 === e.clockseq && (f = f + 1 & 16383), (g < 0 || p > u) && void 0 === e.nsecs && (h = 0), h >= 1e4)
                        throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
                    u = p, d = h, a = f, p += 122192928e5;
                    const b = (1e4 * (268435455 & p) + h) % 4294967296;
                    l[i++] = b >>> 24 & 255, l[i++] = b >>> 16 & 255, l[i++] = b >>> 8 & 255, l[i++] = 255 & b;
                    const _ = p / 4294967296 * 1e4 & 268435455;
                    l[i++] = _ >>> 8 & 255, l[i++] = 255 & _, l[i++] = _ >>> 24 & 15 | 16, l[i++] = _ >>> 16 & 255, l[i++] = f >>> 8 | 128, l[i++] = 255 & f;
                    for (let e = 0; e < 6; ++e)
                        l[i + e] = c[e];
            ...
            9025: (e, t, n) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.URL = t.DNS = void 0, t.default = function (e, t, n) {
                    function i(e, i, r, a) {
                        ...
                        if ("string" == typeof e && (e = function (e) {
                                ...
                                return t;
                            }(e)), "string" == typeof i && (i = (0, s.default)(i)), 16 !== (null === (u = i) || void 0 === u ? void 0 : u.length))
                ...
                var i, o = n(9910), s = (i = n(6792)) && i.__esModule ? i : { default: i };
            ...
            5073: (e, t, n) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.default = void 0;
                var i = r(n(6140)), o = r(n(2858)), s = n(9910);
                function r(e) {
                    return e && e.__esModule ? e : { default: e };
                }
                t.default = function (e, t, n) {
            ...
            7037: (e, t, n) => {
                Object.defineProperty(t, "__esModule", { value: !0 }), t.default = void 0;
                var i, o = (i = n(7656)) && i.__esModule ? i : { default: i };
                t.default = function (e) {
            ...
            7758: e => {
                e.exports = JSON.parse('{"OWNER_URL":"https://ib.adnxs.com/","BIDDING_LOGIC_URL":"https://ib.adnxs.com/ps/cdn/bidding-logic/bidding-current.js","UPDATE_URL":"https://ib.adnxs.com/ps/cc/update-igs","TRUSTED_BIDDING_SIGNALS_URL":"https://ib.adnxs.com/ps/ib/pa/kv","CUSTOM_AD_RENDER_URL":"https://ib.adnxs.com/pa/cr?adRenderCfg=${ADRENDERCFG}","DEFAULT_PRIORITY":10,"DEFAULT_LIFETIME_DAYS":30,"LOCAL_STORAGE_KEY":"ig-joined"}');
            }
        }, t = {};
    function n(i) {
        var o = t[i];
    ...
    (() => {
        const e = n(7028), t = n(7514), i = n(8915), {
                actionQueue: o = [],
                config: s = {}
            } = window && window.pixie || {};
